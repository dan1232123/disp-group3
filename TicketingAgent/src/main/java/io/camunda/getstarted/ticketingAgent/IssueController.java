...
public class IssueController {
    ...
    public Issue inputIssue(@RequestBody IssueDto issueDto) {
        ...
        newIssue.setWarrantyActiveUntil(issueDto.getWarrantyActiveUntil());
...
class IssueDto {
    ...
    private String warantyActiveUntil;
    ...
    public String getWarrantyActiveUntil() {
        return warantyActiveUntil;
    }

    public void setWarrantyActiveUntil(String warantyActiveUntil) {
        this.warantyActiveUntil = warantyActiveUntil;
    }
}
