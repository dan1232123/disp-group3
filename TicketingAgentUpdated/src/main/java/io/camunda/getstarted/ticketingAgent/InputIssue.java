...
public class InputIssue {
    ...
    @ZeebeWorker(type = "input_issue") // Make sure it matches BPMN job type
    public void inputIssue(final JobClient client, final ActivatedJob job) {
        Map<String, Object> variablesAsMap = job.getVariablesAsMap();

// Iterating through the map to log or print the variables
        for (Map.Entry<String, Object> entry : variablesAsMap.entrySet()) {
            String variableName = entry.getKey();
            Object variableValue = entry.getValue();

            // You can log or print the variable name and value here
